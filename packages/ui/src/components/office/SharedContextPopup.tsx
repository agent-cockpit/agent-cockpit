...
import { SharedContextPanel } from '../panels/SharedContextPanel.js'
...
export function SharedContextPopup({ open, onClose }: Props) {
  return (
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                     w-[90vw] max-w-2xl h-[80vh] bg-background rounded-none
        ...
        >
          <div className="cockpit-frame-full flex items-center gap-3 px-4 py-3 border-b border-border shrink-0 bg-[var(--color-panel-surface)]">
            ...
            <Dialog.Title className="cockpit-label">Shared Context</Dialog.Title>
            <Dialog.Close
